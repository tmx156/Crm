// Official UK postcode area codes -> the town/city each area is named after.
const AREA_NAMES = {
  ...
  DY: 'Dudley', E: 'East London', EC: 'East Central London', EH: 'Edinburgh',
  EN: 'Enfield', EX: 'Exeter', FK: 'Falkirk', FY: 'Blackpool', G: 'Glasgow',
  ...
  HU: 'Hull', HX: 'Halifax', IG: 'Ilford', IM: 'Isle of Man', IP: 'Ipswich',
  ...
  ML: 'Motherwell', N: 'North London', NE: 'Newcastle upon Tyne', NG: 'Nottingham',
  ...
  RM: 'Romford', S: 'Sheffield', SA: 'Swansea', SE: 'South East London',
  ...
  TD: 'Galashiels (Scottish Borders)', TF: 'Telford', TN: 'Tonbridge',
  TQ: 'Torquay', TR: 'Truro', TS: 'Cleveland (Teesside)', TW: 'Twickenham',
...
module.exports = { AREA_NAMES, areaName };
